          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              {emailsToInvite.map((email) => {
                return (
                  <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-700 text-zinc-300  flex items-center gap-2">
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5  bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
              ...
              <button type="submit" className="bg-lime-300 text-lime-950 py-2 px-5 rounded-lg flex items-center gap-2 font-medium">
                Convidar
